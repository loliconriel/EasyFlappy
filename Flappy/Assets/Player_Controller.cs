...
public partial class @Player_Controller: IInputActionCollection2, IDisposable
{
    ...
    ~@Player_Controller()
    {
        UnityEngine.Debug.Assert(!m_Keyboard.enabled, "This will cause a leak and performance issues, Player_Controller.Keyboard.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Mobile.enabled, "This will cause a leak and performance issues, Player_Controller.Mobile.Disable() has not been called.");
    }
